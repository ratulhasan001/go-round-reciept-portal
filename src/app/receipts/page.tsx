    ...
    <div className="animate-fade-up">
      ...
      <div className="relative mb-6 overflow-hidden rounded-3xl bg-deep px-6 pb-12 pt-7 text-white sm:px-8 sm:pb-14 sm:pt-9">
        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <SectionIcon section="receipts" className="size-14 rounded-2xl bg-white/10 text-lime ring-1 ring-white/10 backdrop-blur" iconClass="size-7" />
          {shop.logo && (
          ...
          <div>
            ...
            <p className="mt-2 max-w-xl text-[14.5px] text-mint/85">Create a receipt in under a minute. Witness the Underwater World Through Us</p>
          </div>
          </div>
          <Link href="/new" transitionTypes={["nav-right"]} className={buttonClass("accent", "lg", "w-full sm:w-auto")}>
      ...
      <Card className="overflow-hidden">
        ...
        {!ready ? (
          ...
          <div className="flex flex-col items-center gap-3 px-6 py-16 text-center">
            ...
            {!rows.length && (
              <Link href="/new" transitionTypes={["nav-right"]} className={buttonClass("primary")}>
